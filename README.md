...
1. **Add member** Ren to the group for the last day
2. **Poll** the group on where to have the last dinner, nudge stragglers to vote, and close the poll once it's decided.
